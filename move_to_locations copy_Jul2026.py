...
for i in range(0, 1): # numnber of sample types
    for j in range(1, 3): #number of replicates
        force_newtons = []
        force_mpa = []
        distance = []
        compression_percent = []
...
csv_file_name = "20260716_DMAm_DI water_replicate2&3.csv"
...
# for i in range(1, 3): # number of samples 
...
#         compression_percent = []
#         final_measurement = 90
#         maximum_force = 10 # maximum force applied in Newtons, used as a stopping point for the test
...
#         for k in range(0, 50):
#             # change expected sample height here
#             expected_height = 10 # expected height of the sample in mm, used as a starting point for the test
#             cnc.move_to_point(z=-expected_height-(0.5 * k))
#             print("first")
#             final_measurement = 0
...
# # Write everything to CSV at the end
# csv_file_name = "20260619_10 wt%_DMAm_0.5 wt% PDA_fluorescence.csv" # Change csv file name here
